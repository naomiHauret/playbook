...
export interface PlaybookNarrator extends BaseContract {
  ...
  addMessage: TypedContractMethod<[message: string, runId: BigNumberish], [void], 'nonpayable'>
  ...
  onOracleOpenAiLlmResponse: TypedContractMethod<
    [runId: BigNumberish, response: IOracle.OpenAiResponseStruct, errorMessage: string],
    [void],
    'nonpayable'
  >
  ...
  ): TypedContractMethod<[message: string, runId: BigNumberish], [void], 'nonpayable'>
  getFunction(

...
export declare namespace IOracle {
  ...
  export type LlmResponseStructOutput = [
    id: string,
    content: string,
    functionName: string,
    functionArguments: string,
...
export interface IChatGptInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | 'onOracleLlmResponse(uint256,string,string)'
      | 'onOracleLlmResponse(uint256,(string,string,string,string,uint64,string,string,string,uint32,uint32,uint32),string)'
      | 'onOracleOpenAiLlmResponse',
  ): FunctionFragment

  encodeFunctionData(functionFragment: 'getMessageHistory', values: [BigNumberish]): string
  encodeFunctionData(functionFragment: 'getMessageHistoryContents', values: [BigNumberish]): string
  encodeFunctionData(functionFragment: 'getMessageHistoryRoles', values: [BigNumberish]): string
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'onOracleLlmResponse(uint256,string,string)',
    values: [BigNumberish, string, string],
  ): string
  encodeFunctionData(
    functionFragment: 'onOracleLlmResponse(uint256,(string,string,string,string,uint64,string,string,string,uint32,uint32,uint32),string)',
    values: [BigNumberish, IOracle.LlmResponseStruct, string],
  ): string
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'getMessageHistoryContents', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getMessageHistoryRoles', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'onOracleFunctionResponse', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'onOracleGroqLlmResponse', data: BytesLike): Result
...
export interface IChatGpt extends BaseContract {
  ...
  getMessageHistoryContents: TypedContractMethod<[callbackId: BigNumberish], [string[]], 'view'>

  getMessageHistoryRoles: TypedContractMethod<[callbackId: BigNumberish], [string[]], 'view'>
  ...
  onOracleGroqLlmResponse: TypedContractMethod<
    [callbackId: BigNumberish, response: IOracle.GroqResponseStruct, errorMessage: string],
    [void],
    'nonpayable'
  >
  ...
  'onOracleLlmResponse(uint256,string,string)': TypedContractMethod<
    [callbackId: BigNumberish, response: string, errorMessage: string],
    [void],
    'nonpayable'
  >

  'onOracleLlmResponse(uint256,(string,string,string,string,uint64,string,string,string,uint32,uint32,uint32),string)': TypedContractMethod<
    [callbackId: BigNumberish, response: IOracle.LlmResponseStruct, errorMessage: string],
    [void],
    'nonpayable'
  >

  onOracleOpenAiLlmResponse: TypedContractMethod<
    [callbackId: BigNumberish, response: IOracle.OpenAiResponseStruct, errorMessage: string],
    [void],
    'nonpayable'
  >
  ...
  ): TypedContractMethod<[callbackId: BigNumberish], [IOracle.MessageStructOutput[]], 'view'>
  getFunction(
  ...
  >
  getFunction(
    nameOrSignature: 'onOracleLlmResponse(uint256,string,string)',
  ): TypedContractMethod<
    [callbackId: BigNumberish, response: string, errorMessage: string],
    [void],
    'nonpayable'
  >
  getFunction(
    nameOrSignature: 'onOracleLlmResponse(uint256,(string,string,string,string,uint64,string,string,string,uint32,uint32,uint32),string)',
  ): TypedContractMethod<
    [callbackId: BigNumberish, response: IOracle.LlmResponseStruct, errorMessage: string],
    [void],
    'nonpayable'

// @todo - restructure the project as a monorepo to share the following between `website`, `chatbot` and `mru` and avoid code duplication (not in the scope of the hackathon for now as I'm running out of time !)
